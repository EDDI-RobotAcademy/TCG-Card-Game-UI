...
class MyDeckFrame(OpenGLFrame):
    def __init__(self, master=None, **kwargs):
        ...
        self.domain_scene = MyDeckFrameScene()
        ...
        self.renderer = MyDeckFrameRenderer(self.domain_scene, self)
    ...
    def init_shapes(self):
        ...
        my_deck_frame = Rectangle(
            color=(1.0, 0.0, 0.0, 1.0),
            vertices=[(0, 0), (400, 0), (400, 800), (0, 800)],
            translation=(0, 0))
        my_deck_frame.set_draw_gradient(True)
