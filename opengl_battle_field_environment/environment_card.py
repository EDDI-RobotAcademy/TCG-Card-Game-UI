...
class EnvironmentCard:
    ...
    def create_non_background_environment_card_type(self, image_data, center, radius):
    ...
    def init_shapes(self, circle_radius, card_number, rectangle_height, rectangle_width):
        ...
        self.create_non_background_environment_card_type(
        ...
        self.create_non_background_environment_card_race(
