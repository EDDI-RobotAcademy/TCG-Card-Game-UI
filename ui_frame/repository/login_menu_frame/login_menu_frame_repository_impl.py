...
from ui_frame.entity.login_menu_frame import LoginMenuFrame
from ui_frame.repository.login_menu_frame.login_menu_frame_repository import LoginMenuFrameRepository
