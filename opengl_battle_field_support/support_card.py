...
class SupportCard():
    ...
    def create_non_background_support_card_type(self, image_data, center, radius):
        ...
        support_card_type_image = NonBackgroundImage(image_data=image_data,
                                                     vertices=vertices)
        support_card_type_image.set_initial_vertices(vertices)
        self.add_shape(support_card_type_image)

    def create_non_background_support_card_race(self, image_data, center, radius):
        start_x = center[0] - radius * 1.2
        end_x = center[0] + radius * 1.2
        start_y = center[1] - radius * 1.2
        end_y = center[1] + radius * 1.2
        ...
        support_card_race_image = NonBackgroundImage(image_data=image_data,
                                                     vertices=vertices)
        support_card_race_image.set_initial_vertices(vertices)
        self.add_shape(support_card_race_image)
    ...
    def init_shapes(self, circle_radius, card_number, rectangle_height, rectangle_width):
        ...
        self.create_non_background_support_card_type(
        ...
        self.create_non_background_support_card_race(
