...
from opengl_button.button_service.preparing_ok_button import PreparingOkButton
...
class MyCardMainFrameButtonBind:
    def __init__(self, master, frame):
        ...
        self.preparing_ok_button_handler = PreparingOkButton(self.my_card_main_frame)
    ...
    def combined_mouse_click_event(self, event):
        ...
        self.preparing_ok_button_handler.mouse_click_event(event)