...
class MyCardFrame(OpenGLFrame):
    def __init__(self, master=None, **kwargs):
        ...
        self.domain_scene = MyCardFrameScene()
        ...
        self.renderer = MyCardFrameRenderer(self.domain_scene, self)
    ...
    def init_shapes(self):
        ...
        my_card_frame = Rectangle(
            color=(0.0, 0.0, 0.0, 1.0),
            vertices=[(0, 0), (800, 0), (800, 800), (0, 800)],
            translation=(0, 0))
        my_card_frame.set_draw_gradient(True)
        self.domain_scene.add_shape(my_card_frame)
