...
class ResponseGeneration(Enum):
    ...
    CHECK_SEARCH_UNIT_SUPPORT_USAGE = 501
    ...
    REMOVE_OPPONENT_FIELD_ENERGY_ITEM_USAGE = 1008
    ...
    DEPLOY_TARGETING_ATTACK_PASSIVE_SKILL = 2000
    DEPLOY_TARGETING_ATTACK_TO_MAIN_CHARACTER = 2001
    DEPLOY_NON_TARGETING_ATTACK_PASSIVE_SKILL = 2002

    TURN_START_TARGETING_ATTACK_PASSIVE_SKILL = 2010
    TURN_START_TARGETING_ATTACK_TO_MAIN_CHARACTER = 2011
    TURN_START_NON_TARGETING_ATTACK_PASSIVE_SKILL = 2012
