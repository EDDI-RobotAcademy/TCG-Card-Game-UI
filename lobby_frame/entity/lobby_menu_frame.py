...
class LobbyMenuFrame(tkinter.Frame):
    ...
    def load_image(self):
        ...
        self.original_image = Image.open("local_storage/image/battle_lobby/battle_lobby_background.png")
    ...
    def load_and_display_image(self):
        # 이미지 로드 및 Tkinter PhotoImage로 변환
        self.original_image = Image.open("local_storage/image/battle_lobby/battle_lobby_background.png")
        resized_img = self.original_image.resize((self.master.winfo_width(), self.master.winfo_height()), Image.ANTIALIAS)
        self.image = ImageTk.PhotoImage(resized_img)
