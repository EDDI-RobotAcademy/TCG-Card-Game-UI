...
class PreDrawedBattleFieldFrameRefactor(OpenGLFrame):
    ...
    def on_canvas_drag(self, event):
        ...
        if isinstance(self.selected_object, LegacyPickableCard) and self.drag_start:
...
class TestFieldUnitActivePanel(unittest.TestCase):

    def test_field_unit_active_panel(self):
