...
class NotifyReaderControllerImpl(NotifyReaderController):
    ...
    def requestToMappingNoticeWithFunction(self):
        ...
        player_field_energy_function = self.__battleFieldFunctionService.searchOpponentFieldUnitEnergy
        self.__notifyReaderService.savePlayerFieldEnergyFunction(player_field_energy_function)
