...
class PreDrawedBattleFieldFrameRefactor(OpenGLFrame):
    ...
    def init_first_window(self, width, height):
        ...
        self.your_hand_repository.save_current_hand_state([6, 2, 19, 151, 93])
...
class TestResizableEnergyBoostWithSupport(unittest.TestCase):

    def test_resizable_energy_boost_with_support(self):
