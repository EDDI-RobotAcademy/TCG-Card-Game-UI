...
class RectDrawingApp(OpenGLFrame):
    ...
    def redraw(self):
        ...
        lightning_segments.extend(generate_lightning((self.inner_right, -50), (self.inner_right, 50), 10, 5, 0.2, 0.7))
        lightning_segments.extend(generate_lightning((self.inner_left, 50), (self.inner_right, 50), 10, 5, 0.2, 0.7))
        lightning_segments.extend(generate_lightning((self.inner_left, -50), (self.inner_left, 50), 10, 5, 0.2, 0.7))
