...
class ResizableRectangle(OpenGLFrame):
    ...
    def reshape(self, width, height):
        ...
        # self.width_ratio =  self.prev_width / self.current_width
        # self.height_ratio = self.prev_height / self.current_height
    ...
    #         # print(f"battle_field_muligun_background_shape: {battle_field_muligun_background_shape}")
...
class TestRatioBasedCustomRectangleWithNewBackground(unittest.TestCase):
    def test_ratio_based_custom_rectangle_with_new_background(self):
