...
class PickingCardLightningBorderFrame(OpenGLFrame):
    ...
    def redraw(self):
        ...
        if self.selected_object:
            ...
            lightning_start = (
                pickable_unit_card_base.vertices[0][0] + local_translation[0],
                pickable_unit_card_base.vertices[0][1] + local_translation[1]
            )
            lightning_end = (
                pickable_unit_card_base.vertices[2][0] + local_translation[0],
                pickable_unit_card_base.vertices[2][1] + local_translation[1]
            )

            lightning_segments = generate_lightning(
                lightning_start, lightning_end, 10, 5, 0.2, 0.7)
    ...
    def draw_lightning_for_selected(self):
        if self.selected_object:
            pickable_unit_card_base = self.selected_object.get_pickable_card_base()
            local_translation = pickable_unit_card_base.get_local_translation()
