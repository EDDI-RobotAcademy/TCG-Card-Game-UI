...
class RequestUseAddFieldEnergyBySacrificingFieldUnitSupportCard:
    ...
    def __str__(self):
        return f"RequestUseAddFieldEnergyBySacrificingFieldUnitSupportCard(protocolNumber={self.__protocolNumber}, unitIndex={self.__unitIndex}, sessionInfo={self.__sessionInfo}, itemCardId={self.__itemCardId})"
