...
from battle_field.state.legacy.circle_image_legacy_deck_page import CircleImageLegacyDeckPage
from pre_drawed_image_manager.pre_drawed_image import PreDrawedImage


class CircleImageLegacyYourDeckRepository:
    __instance = None
    ...
    def build_deck_page(self):
        ...
        for page_index in range(num_pages):
            ...
            current_page = CircleImageLegacyDeckPage()
