...
class OpponentDetailsPanel:
    ...
    def get_opponent_details_panel(self):
        return self.opponent_details_panel

    def clear_all_opponent_details_panel(self):
        self.clear_opponent_details_panel_button()
        self.clear_opponent_details_panel()

    def clear_opponent_details_panel(self):
        del self.opponent_details_panel
        self.opponent_details_panel = None

    def get_opponent_details_panel_button(self):
        return self.opponent_details_panel_button

    def clear_opponent_details_panel_button(self):
        del self.opponent_details_panel_button
        self.opponent_details_panel_button = None
    ...
    def create_opponent_details_panel(self, start_point, right_clicked_object):
        ...
        self.opponent_details_panel = Rectangle(
            rectangle_color,
            [
        ...
        print(f"opponent_details_panel -> start_point: {start_point}, end_point: {end_point}")
        ...
        self.opponent_details_panel_button = self.create_details_button(
    ...
    def is_point_inside_details_button(self, point):
        ...
        details_button = self.get_opponent_details_panel_button()
