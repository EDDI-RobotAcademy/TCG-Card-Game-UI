...
class OpponentFieldPanel:
    ...
    def get_opponent_field_panel(self):
        return self.opponent_field_panel

    def change_local_translation(self, _translation):
        self.local_translation = _translation

    def create_opponent_field_panel(self):
        ...
        self.opponent_field_panel = Rectangle(
            (0.0, 0.0, 0.0, 0.1),
            [
        ...
        self.opponent_field_panel.set_draw_border(False)
