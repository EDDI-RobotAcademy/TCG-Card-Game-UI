from card.card_right_up_rendering.entity.card_right_up_rendering import CardRightUpRendering
from card.card_right_up_rendering.repository.card_right_up_rendering_repository import CardRightUpRenderingRepository


class CardRightUpRenderingRepositoryImpl(CardRightUpRenderingRepository):
    __instance = None
    ...
    def createCardRightUpRenderingFrame(self, rootWindow):
        ...
        cardRightUpRendering = CardRightUpRendering(rootWindow)
        circle_radius = 12  # 반지름 값, 적절하게 조절해주세요

        # Calculate the coordinates of the bounding box
        x1 = y1 = 25 - circle_radius
        x2 = y2 = 25 + circle_radius
        self.drawCircle(cardRightUpRendering.canvas, x1, y1, x2, y2, fill='purple', outline='black', width=1, text="Race")
