...
class LegacyTrapCard:
    ...
    def create_trap_race_illustration_circle(self, image_data, center, radius):
        trap_race_circle = CircleImage(image_data=image_data,
                                       center=center,
                                       radius=radius)
        self.add_shape(trap_race_circle)

    def create_trap_type_illustration_circle(self, image_data, center, radius):
        trap_type_circle = CircleImage(image_data=image_data,
                                       center=center,
                                       radius=radius)
        self.add_shape(trap_type_circle)


    def init_shapes(self, circle_radius, card_number, rectangle_height, rectangle_width):
        project_root = get_project_root()

        self.create_trap_race_illustration_circle(
        ...
        self.create_trap_type_illustration_circle(
