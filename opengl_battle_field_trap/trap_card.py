...
class TrapCard:
    ...
    def create_trap_race_illustration_circle(self, image_path, center, radius):
        trap_race_circle = ImageCircleElement(image_path=image_path,
                                              center=center,
                                              radius=radius)
        self.add_shape(trap_race_circle)

    def create_trap_type_illustration_circle(self, image_path, center, radius):
        trap_type_circle = ImageCircleElement(image_path=image_path,
                                              center=center,
                                              radius=radius)
