...
class BattleFieldMuligunScene:
    ...
    def create_battle_field_muligun_scene(self):
        self.create_battle_field_muligun_background()

    def create_battle_field_muligun_background(self):
        self.battle_field_muligun_background = BattleFieldMuligunBackground()
        self.battle_field_muligun_background.init_shapes()
