...
class PreDrawedImage:
    ...
    def pre_draw_opponent_tomb(self):
        ...
        self.__pre_drawed_tomb = ImageDataLoader.load_rectangle_image_data(tomb_image_path)
    ...
    def pre_draw_opponent_lost_zone(self):
        ...
        self.__pre_drawed_lost_zone = ImageDataLoader.load_rectangle_image_data(lost_zone_image_path)
    ...
    def pre_draw_opponent_trap(self):
        ...
        self.__pre_drawed_trap = ImageDataLoader.load_rectangle_image_data(trap_image_path)
